...
2. **본문 실사 이미지 프롬프트**:
   - `[IMAGE_PLACEHOLDER_1]`, `[IMAGE_PLACEHOLDER_2]`, `[IMAGE_PLACEHOLDER_3]` 각각에 대응하는 상세 AI 이미지 생성 프롬프트(영문 및 한글 해설)를 **정확히 3개** 작성한다. 실제 현장 사진 구도로 작성한다.
